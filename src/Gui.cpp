#include "Gui.h"
#if 0
#pragma region https: //stackoverflow.com/questions/13326715/rendertargetview-to-shaderresourceview
//global declarations:
...
#pragma region https: //github.com/ocornut/imgui/wiki/Image-Loading-and-Displaying-Examples
...
int Gui::Init()
{
    ...
    bool ret = LoadTextureFromFile("8821.jpg", &my_texture, &my_image_width, &my_image_height);
    IM_ASSERT(ret);
