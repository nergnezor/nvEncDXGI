...
void StartApps()
{
	...
	ShellExecuteA(0, 0, "chrome.exe", "http://m.facebook.com --kiosk", 0, SW_SHOWNORMAL);
...
int Gui::Init()
{
	...
	HWND hwnd = ::CreateWindow(
		...
		100, 100, 600, 800, NULL, NULL, wc.hInstance, NULL);
	...
	bool ret = LoadTextureFromFile("8821.jpg", &my_texture, &my_image_width,
		&my_image_height);
	IM_ASSERT(ret);
